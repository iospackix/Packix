...
export class AccountApi extends BaseLoopBackApi {
   ...
   * </em>
   */
   linkGroups(id, fk, data, customHeaders) {
   ...
   * This method returns no data.
   */
   unlinkGroups(id, fk, customHeaders) {
   ...
   * </em>
   */
   existsGroups(id, fk, customHeaders) {
   ...
   * </em>
   */
   getGroups(id, filter, customHeaders) {
   ...
   * </em>
   */
   getPackageGifts(id, filter, customHeaders) {
   ...
   *  - `count` – `{number}` - 
   */
   countPackageGifts(id, where, customHeaders) {
