...
export class PackageRefundRequestApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation linkedAccount.
   *
   * @param {any} id PackageRefundRequest id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getLinkedAccount(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PackageRefundRequests/:id/linkedAccount";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getPurchase(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * This method returns no data.
   */
  public decline(id: any, reason: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
