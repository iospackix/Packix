...
export class DeveloperPreferencesApi extends BaseLoopBackApi {
  ...
  /**
   * Test PayPal Client ID and Secret
   *
   * @param {object} data Request data.
   *
   *  - `req` – `{object}` - 
   ...
   * </em>
   */
  public testPayPal(req: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DevelopersPreferences/testPayPal";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
  ...
  /**
   * Test Patreon Creator Access Token
   *
   * @param {object} data Request data.
   *
   *  - `req` – `{object}` - 
   ...
   * </em>
   */
  public testPatreon(req: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DevelopersPreferences/testPatreon";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
